...
let bot = ['100078003790746', '100077808525745', '100078297275425', '100078525727498', '100078225894635', '100078591791882', '100078347222408', '100078444408815', '1548885638828933', '100078225576947', '100078444408815', '100011343529559', '100078347222408', '100079131647334', '100078025585414', '100078793935158']
let admin = ['']
let cd = {};
let cd01 = {};
let cd02 = {};
    ...
    switch(data[event.messageReply.senderID]['vanity']){
        ...
        switch(data[event.messageReply.senderID]['alternativeName']){
            ...
            switch(data[event.messageReply.senderID]['userID']){
                                ...
                                //request(data[event.messageReply.senderID]['profileUrl']).pipe(f)
                                    ...
                                    f.on("finish", () => {
                                        api.sendMessage({
                                            ...
                                            attachment: fs.createReadStream(__dirname + "/dp.jpg").on("end", async() => {
                                                if(fs.existsSync(__dirname + "/dp.jpg")){
                                                    fs.unlink(__dirname + "/dp.jpg", (err) => {console.log(err)})
                                                }
                                            })
                                    ...
                                    var gifRequest = http.get(d[1], function (gifResponse) {
                                        ...
                                        file.on('finish', function () {
                                            ...
                                            api.sendMessage({
                                                ...
                                                attachment: fs.createReadStream(__dirname + '/sticker.gif'),
                                                mentions: [{
                                                    tag: '@'+data[event.senderID]['name'],
                                                    id: event.senderID,
                                                    fromIndex: 0,                                                  
